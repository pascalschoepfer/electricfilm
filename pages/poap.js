        ...
        <div>
                        ...
                        <div className="accordion" id="accordionMM">
                                ...
                                <div id="collapseOneMM" className="accordion-collapse collapse show"
                                    ...
                                    <div className="accordion-body">
                                        <i>If you already have a Crypto Wallet, you can directly go to the second
                                            section &ampGet the POAP&amp.</i> <br/><br/>
                                        <div>Download and install a Crypto Wallet on your mobile phone, we recommend &ampMetaMask&amp:</div>
                                        <br/>
                                        <Button className='btn-lg d-flex p-2'>
                                            <svg id='svgMM' viewBox="0 0 318.6 318.6">
                                            ...
                                            <a className='mx-2 p-3'>Download MetaMask</a>
                                        </Button>
                                    </div>
                                </div>
                            </div>
                            <div className="accordion-item">
                                ...
                                <div id="collapseTwoMM" className="accordion-collapse collapse"
                                    ...
                                    <div className="accordion-body">
                                        <div>
                                            After starting the MetaMask app and selecting &ampGet Started&amp, click on
                                            &ampCreate a new wallet&amp.
                                        </div>
                            ...
                            <div className="accordion-item">
                                <h2 className="accordion-header" id="headingThree">
                                    <button className="accordion-button collapsed" type="button"
                                        ...
                                        3. Finish wallet setup and copy your new address
                                    </button>
                                </h2>
                                <div id="collapseThreeMM" className="accordion-collapse collapse"
                                    ...
                                    <div className="accordion-body">
                                        <div className="mb-3">
                                            ...
                                            app.<br/> <br/>
                                            If you dont have time or a pen and a paper, click &ampRemind me later&amp to get
                                            to
                        ...
                        <div className="accordion" id="accordionPOAP">
                            <div className="accordion-item">
                                <h2 className="accordion-header" id="headingOne">
                                    <button className="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        1. Download and install the POAP app
                                    </button>
                                </h2>
                                <div id="collapseOnePOAP" className="accordion-collapse collapse show"
                                    ...
                                    <div className="accordion-body">
                                        ...
                                        <div className="row ">
                                            <Button className='btn-lg col-5 p-2 m-2'>
                                                <a className='mx-2'>Apple iOS</a>
                                                <FontAwesomeIcon className='' icon={faApple}/>
                                            </Button>
                                            <Button className='btn-lg col-5 p-2 m-2'>
                                                <a className='mx-2'>Android</a>
                                                <FontAwesomeIcon className='pt-2' icon={faAndroid}/>
                                            </Button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseThreePOAP" className="accordion-collapse collapse"
                                     data-bs-parent="#accordionPOAP">
                                    <div className="accordion-body">
                                        Now you are ready to claim a POAP. Click &ampMint&amp and then &ampScan QR&amp to scan the
                                        QR code handed out by the team on site or use the &ampSecret word&amp if you have
                                        received one.
                                    </div>
            ...
            <div className="container container-video text-center p-4 col-xl-4 col-md-6 col-sm-8 col-11">
                <div className="nav nav-pills row justify-content-center">
                    <a className='btn btn-lg col-8' href='https://youtu.be/pY17ck2Hx8k' target="_blank" rel="noopener noreferrer">
